...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    if(jugador.isTouching(monedaGroup)){
      score = score + 1;
...
function reset(){
  ...
  //destruye el grupo arbustos y obstáculosfunction reiniciarJuego() {
  
  canguro.changeAnimation("correr");

  arbustosGroup.destroyEach();
